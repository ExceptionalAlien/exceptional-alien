...
export default function TermsAndPrivacy({ page }: PageProps) {
  return (
    <>
      ...
      <main className="min-h-full p-4 md:p-6 pt-12 md:pt-20 pb-12 md:pb-20 max-w-xl md:max-w-2xl lg:max-w-3xl xl:max-w-4xl 2xl:max-w-5xl m-auto [&>section]:mt-8 [&>section]:md:mt-12 [&>[data-slice-type=text\_with\_heading]]:mt-5">
