...
export default function Quote(props: QuoteProps) {
  return (
    <div className="w-4/5 md:w-2/5">
      <div className="aspect-[4/3] relative border border-ex-blue p-3 md:p-4 [&_p]:text-ex-blue [&>p]:font-bold [&>p]:text-base [&>p]:md:text-lg [&>p]:mb-3 [&>p]:md:mb-4 [&>p]:pb-10 [&>p]:md:pb-12">
