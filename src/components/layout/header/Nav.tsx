...
export default function Nav({
  ...
  return (
    <nav
      className={`group/nav fixed top-0 flex w-full flex-col items-center justify-center overflow-hidden bg-white transition-[opacity] duration-300 ease-in md:static md:ml-auto md:w-auto md:flex-row md:bg-transparent ${
        showingNav ? "h-full opacity-100" : "h-0 opacity-0 md:h-full md:opacity-100"
      }`}
    >
      {/* Download app */}
      <Link
