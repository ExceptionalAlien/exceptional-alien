  ...
  return (
    ...
    >
      ...
      {props.category === "Food & Drink" && (
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" data-name="Layer 1" viewBox="0 0 17 18.09">
      ...
      {props.category === "Nature" && (
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" data-name="Layer 1" viewBox="0 0 13.25 19.64">
      ...
      {props.category === "Accommodation" && (
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" data-name="Layer 1" viewBox="0 0 20.03 15.15">
      ...
      {props.category === "Culture" && (
        <svg
          ...
          className={`${!props.hideBg && "mb-[2px] md:mb-[3px]"}`}
        >
      ...
      {props.category === "Events" && (
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" data-name="Layer 1" viewBox="0 0 17.21 18.07">
      ...
      {props.category === "Wellness" && (
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" data-name="Layer 1" viewBox="0 0 19 15.82">
