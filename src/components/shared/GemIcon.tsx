  ...
  return (
    ...
    >
      ...
      {category === "Neighbourhoods" && (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48.99 48.96" className="gem-icon-symbol">
          <path d="m24.505 33.98-.448-.603c-.252-.328-6.133-8.114-6.133-11.64 0-3.723 2.946-6.757 6.571-6.757 3.625 0 6.571 3.034 6.571 6.757.032 2.738-5.499 10.721-6.123 11.63l-.426.613h-.012Zm-.022-17.905c-3.022 0-5.475 2.54-5.475 5.662 0 2.409 3.592 7.83 5.454 10.37 1.861-2.738 5.508-8.498 5.497-10.37 0-3.132-2.453-5.673-5.476-5.673v.011Z" />
          <path d="M24.483 24.847a3.295 3.295 0 0 1-3.285-3.286 3.294 3.294 0 0 1 3.285-3.284 3.294 3.294 0 0 1 3.286 3.284 3.295 3.295 0 0 1-3.286 3.286Zm0-5.476c-1.204 0-2.19.986-2.19 2.19 0 1.205.986 2.191 2.19 2.191a2.197 2.197 0 0 0 2.191-2.191c0-1.204-1.007-2.19-2.191-2.19Z" />
        </svg>
      )}
    </div>
  );
