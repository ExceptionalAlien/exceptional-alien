...
const TextWithHeading = ({ slice }: TextWithHeadingProps): JSX.Element => {
  return (
    <section
      className={`text-ex-grey [&>h4]:text-xl [&>h4]:md:text-2xl [&>ol]:mt-4 [&>ol]:list-decimal [&>ol]:pl-8 [&>p>a]:underline [&>p>a]:transition-[color] [&>p>a]:duration-300 [&>p>a]:ease-in-out hover:[&>p>a]:text-ex-light-grey [&>p]:mt-4 [&>ul]:mt-4 [&>ul]:list-disc [&>ul]:pl-8 ${
