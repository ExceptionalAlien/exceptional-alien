    ...
    <section
      className={`text-ex-grey [&>p]:mt-4 [&>ul]:mt-4 [&>ul]:list-disc [&>ul]:pl-8 [&>ol]:mt-4 [&>ol]:list-decimal [&>ol]:pl-8 [&>p>a]:underline hover:[&>p>a]:text-ex-light-grey [&>p>a]:transition-[color] [&>p>a]:ease-in-out [&>p>a]:duration-300 ${
        slice.variation === "columns"
          ? "[&>h4]:font-bold [&>h4]:text-xl [&>h4]:md:text-2xl [&>h4]:md:float-left [&>h4]:md:w-1/3 [&>h4]:md:pr-6 [&>p]:md:float-right [&>p]:md:w-2/3 [&>ul]:md:float-right [&>ul]:md:w-2/3 [&>ol]:md:float-right [&>ol]:md:w-2/3 [&>*:nth-child(2)]:md:mt-0"
          : "[&>h4]:text-xl [&>h4]:md:text-2xl"
      }`}
